...
export function CreateClientModal({ onClose }: CreateClientModalProps) {
  const { createClient } = useClientsData('');
      ...
      >
        ...
        >
          <div className="text-white">
            <h2 className="text-2xl font-bold mb-1">Novo Cliente</h2>
            <p className="text-sm opacity-90">Preencha as informações do cliente</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 overflow-y-auto max-h-[calc(90vh-200px)]">
          ...
          <div className="flex gap-3 mt-8">
            ...
            <button
              ...
              style={{
                background: createClient.isPending 
                  ? '#9ca3af' 
